 ...
 *
 */
TutorialAnimation::TutorialAnimation(const char* data, const char* texture, Node* parent)
: Spine(data, texture, 1.0, parent, true)
{
 ...
 *
 */
void TutorialAnimation::onEnter()
{
  Spine::onEnter();
 ...
 *
 */
void TutorialAnimation::onAnimationEvent(int index, spEvent* event)
{

...
Credits = Popup.extend({
  ...
  ctor: function() {
    ...
    this.text = [
      ...
      new Text('credits-title-2', this.backgrounds.scroll),
      new Text('credits-title-3', this.backgrounds.scroll),
      new Text('credits-title-4', this.backgrounds.scroll),
      new Text('credits-title-5', this.backgrounds.scroll),
      new Text('credits-title-6', this.backgrounds.scroll),
      new Text('credits-title-7', this.backgrounds.scroll),
